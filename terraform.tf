provider "aws" {
  ...
  access_key = "AKIAWPVPXDWESBZN2P5A"
  secret_key = "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"
}
...
resource "aws_network_interface_sg_attachment" "sg_attachment" {
  ...
  network_interface_id = data.aws_instance.ec2_instance.network_interface_id
}    
